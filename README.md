...
ST_EVENTS_URL="https://api.myswitzerland.io/v1/events"  # if using ST GET events API
ST_SEARCH_URL="https://api.discover.swiss/info/v2/search"  # if using Discover Swiss POST search API
ST_SUBSCRIPTION_KEY="your_subscription_key_if_required"   # used for ST_SEARCH_URL
