...
class GOViSScraper {
    ...
    parseSwissDate(dateText) {
        ...
        if (numericMatch) {
            ...
            start = new Date(parseInt(year), parseInt(month) - 1, parseInt(day), hour ? parseInt(hour) : 0, minute ? parseInt(minute) : 0);
        }
    ...
    async parseAlternativeFormat($, municipality) {
...
exports.GOViSScraper = GOViSScraper;
